"""Build the SR-MICRO4 server deployment zip."""
...
PAYLOAD = [
    "docs/plans/2026-09-15-server-micro4-protocol.md",
    "scripts/experiments/server_short_tol_probe.py",
    "scripts/experiments/server_failure_mechanism_audit.py",
    "tools/server_micro4_queue.py",
    "tools/install_server_micro4.py",
...
def main() -> None:
    out = PROJECT_DIR / "evidence/server_resource_v1/server_micro4_bundle.zip"
    if out.exists():
        out.unlink()
    manifest = {"schema": "pidon-server-micro4-bundle-v1", "payload": {}}
    with zipfile.ZipFile(out, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.write(PROJECT_DIR / "tools/install_server_micro4.py", "install_server_micro4.py")
