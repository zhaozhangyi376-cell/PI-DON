"""Build the SR-MICRO16 server deployment zip."""
...
PAYLOAD = [
    "docs/plans/2026-09-15-server-micro16-protocol.md",
    "scripts/experiments/server_short_tol_probe.py",
    "scripts/experiments/server_failure_mechanism_audit.py",
    "tools/server_micro16_queue.py",
    "tools/install_server_micro16.py",
...
def main() -> None:
    out = PROJECT_DIR / "evidence/server_resource_v1/server_micro16_bundle.zip"
    if out.exists():
        out.unlink()
    manifest = {"schema": "pidon-server-micro16-bundle-v1", "payload": {}}
    with zipfile.ZipFile(out, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.write(PROJECT_DIR / "tools/install_server_micro16.py", "install_server_micro16.py")
