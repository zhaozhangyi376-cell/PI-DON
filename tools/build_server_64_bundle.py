"""Build the SR-64 server deployment zip."""
...
PAYLOAD = [
    ...
    "tools/server_64_queue.py",
    "tools/install_server_64.py",
...
def main() -> None:
    out = PROJECT_DIR / "evidence/server_resource_v1/server_64_bundle.zip"
    if out.exists():
        out.unlink()
    manifest = {"schema": "pidon-server-64-bundle-v1", "payload": {}}
    with zipfile.ZipFile(out, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.write(PROJECT_DIR / "tools/install_server_64.py", "install_server_64.py")
