...
def formal_run_identity(a):
    """Stable identity of dynamics and code, independent of output location."""
    ...
    return {"run_id": digest, "protocol_hash": digest, **document}
...
def main():
    ...
    recorder = None
    if a.out_dir:
        identity = formal_run_identity(a)
