...
## #293　2026-09-15T13:08:41　FAILED (exit 1)

**SERVER_SMOKE: lab_log wrapper check**
...
- 耗时 0s ｜ commit `?` (?)
- WS-04 ｜ Windows 10 ｜ python 3.11.16 ｜ torch 2.5.1+cu121 ｜ Quadro GV100

<details><summary>输出末尾</summary>

```
脚本不存在或名称不唯一: lis；用 run.py list 查看。
```

</details>

## #294　2026-09-15T13:30:08　OK
...
```
diag_coords                            scripts/exploratory/diag_coords.py
diag_exp3                              scripts/exploratory/diag_exp3.py
manifold_check                         scripts/exploratory/manifold_check.py
mini2d                                 scripts/exploratory/mini2d.py
structured                             scripts/exploratory/structured.py
structured3d                           scripts/exploratory/structured3d.py
structured_cavity                      scripts/exploratory/structured_cavity.py
structured_deep                        scripts/exploratory/structured_deep.py
structured_material                    scripts/exploratory/structured_material.py
structured_pec                         scripts/exploratory/structured_pec.py
structured_scale                       scripts/exploratory/structured_scale.py
symplectic                             scripts/exploratory/symplectic.py
test_coverage_ab                       tests/test_coverage_ab.py
test_direct_mechanism_m0               tests/test_direct_mechanism_m0.py
test_head_lstsq                        tests/test_head_lstsq.py
test_mechanism_claims                  tests/test_mechanism_claims.py
test_mechanism_decision_eval           tests/test_mechanism_decision_eval.py
test_mechanism_first_failure           tests/test_mechanism_first_failure.py
test_mechanism_hour                    tests/test_mechanism_hour.py
test_night_budget                      tests/test_night_budget.py
test_night_evidence                    tests/test_night_evidence.py
test_paper_protocol                    tests/test_paper_protocol.py
test_phase1_pilot                      tests/test_phase1_pilot.py
test_pidon_contract                    tests/test_pidon_contract.py
test_pidon_contract_v3                 tests/test_pidon_contract_v3.py
test_pidon_contract_v4                 tests/test_pidon_contract_v4.py
test_project_harness                   tests/test_project_harness.py
test_r4_fixed_state                    tests/test_r4_fixed_state.py
test_r4_p4a                            tests/test_r4_p4a.py
test_run_entrypoint                    tests/test_run_entrypoint.py
test_stop_review_claims                tests/test_stop_review_claims.py
test_trunk_repair                      tests/test_trunk_repair.py
audit_reorganization_delivery          tools/audit_reorganization_delivery.py
build_project_state                    tools/build_project_state.py
finalize_layout                        tools/finalize_layout.py
project_harness                        tools/project_harness.py
reorganize_workspace                   tools/reorganize_workspace.py
repair_layout_paths                    tools/repair_layout_paths.py
validate_workspace_layout              tools/validate_workspace_layout.py
write_reorganization_report            tools/write_reorganization_report.py
```

</details>

## #295　2026-09-15T16:53:09　OK

**S1R server phase1 full run**

```
python run.py --action A-20260915T054513-93c57d73 phase1_full_run_s1r --action-id A-20260915T054513-93c57d73 --device cuda --microbatch 4 --eval-batch 2
```

- 耗时 11195s ｜ commit `?` (?)
- WS-04 ｜ Windows 10 ｜ python 3.11.16 ｜ torch 2.5.1+cu121 ｜ Quadro GV100
- 抓到的关键数：`nMAE = ['4.150e-02', '1.144e-01', '2.313e-01', '1.777e-01']`

| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/direct_mechanism_v2/s1r_phase1_server/train_dev_data.npz` | 703,342 KB | `(太大,未哈希)` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/last.pt` | 108,516 KB | `2cd8c5b03a10ce53` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/best.pt` | 108,514 KB | `958a976476476fa0` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/blind_data/blind_64x64x64.npz` | 89,653 KB | `103f0463c23d7cec` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/blind_data/blind_64x96x16.npz` | 33,633 KB | `8b361e56f30bcedb` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/blind_data/blind_32x32x32.npz` | 11,224 KB | `f1478445d3d80ee6` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/blind_data/blind_32x64x16.npz` | 11,222 KB | `2f83519c2a61c541` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/train_dev_specs.json` | 2,827 KB | `e03bcf9d92b947dc` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/audit.json` | 230 KB | `46e5409ddebc30a9` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/history.jsonl` | 146 KB | `0572dd020b80f8c3` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/summary.json` | 110 KB | `2b63a96d0eb1376b` |
| `evidence/direct_mechanism_v2/s1r_phase1_server/blind_specs.json` | 40 KB | `503735229ec3521c` |
| … 另有 4 个 | | |

<details><summary>输出末尾</summary>

```
epoch  980 updates 24500 train 1.391e-04 dev_nMAE 2.195e-02 dev_relL2p90 5.474e-02 dev_MRE 1.700e+00 elapsed 9891.1s
epoch  981 updates 24525 train 1.391e-04 elapsed 9902.4s
epoch  982 updates 24550 train 1.390e-04 elapsed 9912.2s
epoch  983 updates 24575 train 1.390e-04 elapsed 9921.9s
epoch  984 updates 24600 train 1.388e-04 elapsed 9931.7s
epoch  985 updates 24625 train 1.389e-04 elapsed 9941.5s
epoch  986 updates 24650 train 1.388e-04 elapsed 9951.2s
epoch  987 updates 24675 train 1.386e-04 elapsed 9961.0s
epoch  988 updates 24700 train 1.385e-04 elapsed 9970.7s
epoch  989 updates 24725 train 1.384e-04 elapsed 9980.5s
epoch  990 updates 24750 train 1.383e-04 dev_nMAE 2.187e-02 dev_relL2p90 5.485e-02 dev_MRE 1.740e+00 elapsed 9990.3s
epoch  991 updates 24775 train 1.382e-04 elapsed 10001.5s
epoch  992 updates 24800 train 1.381e-04 elapsed 10011.3s
epoch  993 updates 24825 train 1.381e-04 elapsed 10021.1s
epoch  994 updates 24850 train 1.379e-04 elapsed 10030.8s
epoch  995 updates 24875 train 1.381e-04 elapsed 10040.6s
epoch  996 updates 24900 train 1.379e-04 elapsed 10050.4s
epoch  997 updates 24925 train 1.377e-04 elapsed 10060.1s
epoch  998 updates 24950 train 1.376e-04 elapsed 10069.9s
epoch  999 updates 24975 train 1.375e-04 elapsed 10079.6s
epoch 1000 updates 25000 train 1.374e-04 dev_nMAE 2.189e-02 dev_relL2p90 5.470e-02 dev_MRE 1.754e+00 elapsed 10089.4s
blind 32x32x32 gate=False nMAE=4.150e-02 relL2p90=4.412e-02 MRE=1.053e+00
blind 64x64x64 gate=False nMAE=1.144e-01 relL2p90=1.315e-01 MRE=1.477e+00
blind 64x96x16 gate=False nMAE=2.313e-01 relL2p90=4.440e-01 MRE=3.328e+00
blind 32x64x16 gate=False nMAE=1.777e-01 relL2p90=3.710e-01 MRE=4.004e+00
{
  "status": "PASS",
  ...
  "best": {
    "epoch": 970,
    "updates": 24250,
    "dev_macro_nmae": 0.021864366444440054,
    "dev_global_rel_l2_p90": 0.05483918295894334,
    "dev_macro_mre_eq5_mean": 1.7609199891979859
  },
  "blind_gate_pass": false,
  "report": "evidence/direct_mechanism_v2/s1r_phase1_server/S1_REPORT.md",
  "summary": "evidence/direct_mechanism_v2/s1r_phase1_server/summary.json"
}
```

</details>

## #296　2026-09-15T17:41:02　OK

**SR-COMPARE: 服务器三模型同题重测与S1R原始证据审核**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T094044-78db962e server_phase1_compare --action-id A-20260915T094044-78db962e --device cuda
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/phase1_compare/old_lr1e3_64x64x64_pred.npy` | 49,152 KB | `164d2d305c970ead` |
| `evidence/server_resource_v1/phase1_compare/old_paper32_64x64x64_pred.npy` | 49,152 KB | `10fb4f7a74b948b6` |
| `evidence/server_resource_v1/phase1_compare/S1R_best_64x64x64_pred.npy` | 49,152 KB | `a47f580e859d49b3` |
| `evidence/server_resource_v1/phase1_compare/old_lr1e3_64x96x16_pred.npy` | 18,432 KB | `27ef050f2ff9a055` |
| `evidence/server_resource_v1/phase1_compare/old_paper32_64x96x16_pred.npy` | 18,432 KB | `fa920e76476431cb` |
| `evidence/server_resource_v1/phase1_compare/S1R_best_64x96x16_pred.npy` | 18,432 KB | `8d64a42e67783971` |
| `evidence/server_resource_v1/phase1_compare/old_lr1e3_32x32x32_pred.npy` | 6,144 KB | `5a3ee31b0e234b7d` |
| `evidence/server_resource_v1/phase1_compare/old_lr1e3_32x64x16_pred.npy` | 6,144 KB | `54066447c127cda5` |
| `evidence/server_resource_v1/phase1_compare/old_paper32_32x32x32_pred.npy` | 6,144 KB | `37378006b63e51c3` |
| `evidence/server_resource_v1/phase1_compare/old_paper32_32x64x16_pred.npy` | 6,144 KB | `6e2daa0487648eb7` |
| `evidence/server_resource_v1/phase1_compare/S1R_best_32x32x32_pred.npy` | 6,144 KB | `5c92bd0eb4654b69` |
| `evidence/server_resource_v1/phase1_compare/S1R_best_32x64x16_pred.npy` | 6,144 KB | `d04a7ed3e2f13f21` |
| … 另有 13 个 | | |

<details><summary>输出末尾</summary>

```
old_paper32 32x32x32 PASS
old_paper32 64x64x64 PASS
old_paper32 64x96x16 PASS
old_paper32 32x64x16 PASS
old_lr1e3 32x32x32 PASS
old_lr1e3 64x64x64 PASS
old_lr1e3 64x96x16 PASS
old_lr1e3 32x64x16 PASS
S1R_best 32x32x32 PASS
S1R_best 64x64x64 PASS
S1R_best 64x96x16 PASS
S1R_best 32x64x16 PASS
{"status": "PASS", "output": "H:\\PI-DON\\evidence\\server_resource_v1\\phase1_compare"}
```

</details>

## #297　2026-09-15T17:41:20　OK

**SR-PERF: GV100等效批次吞吐测试**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T094102-1285f598 server_compute_probe --action-id A-20260915T094102-1285f598 --device cuda
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/compute_probe/micro16_last.pt` | 108,454 KB | `8e0d89c024acb6c1` |
| `evidence/server_resource_v1/compute_probe/micro4_last.pt` | 108,454 KB | `f34a3bedc458d84d` |
| `evidence/server_resource_v1/compute_probe/micro8_last.pt` | 108,454 KB | `67484c8b55109630` |
| `evidence/server_resource_v1/compute_probe/initial.pt` | 36,143 KB | `06f855d498751928` |
| `evidence/server_resource_v1/compute_probe/source/src/pidon/pidon_solve.py` | 70 KB | `5d6eb695526117ef` |
| `evidence/server_resource_v1/compute_probe/source/scripts/experiments/phase1_full_run.py` | 29 KB | `e54a1c1576df5af8` |
| `evidence/server_resource_v1/compute_probe/source/scripts/experiments/server_local_review.py` | 15 KB | `fcfe323ea60504f8` |
| `evidence/server_resource_v1/compute_probe/source/src/pidon/pidon_recording.py` | 14 KB | `6a22cf4e2dcafba7` |
| `evidence/server_resource_v1/compute_probe/source/src/pidon/dco.py` | 13 KB | `1bc6c9de416064e3` |
| `evidence/server_resource_v1/compute_probe/source/src/pidon/pidon_contract.py` | 11 KB | `fbf93008fd698a03` |
| `evidence/server_resource_v1/compute_probe/source/scripts/experiments/server_phase1_compare.py` | 10 KB | `450ea1101425e4c4` |
| `evidence/server_resource_v1/compute_probe/source/scripts/experiments/server_compute_probe.py` | 8 KB | `a553515c185a9b79` |
| … 另有 10 个 | | |

<details><summary>输出末尾</summary>

```
microbatch 4 PASS committed 5
microbatch 8 PASS committed 5
microbatch 16 PASS committed 5
{"status": "PASS", "output": "H:\\PI-DON\\evidence\\server_resource_v1\\compute_probe", "updates": 15}
```

</details>

## #298　2026-09-15T18:20:23　FAILED (exit 1)

**SR-SHORT TOL1E5-P bounded 64-step field probe**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T101559-5bba5bc1 server_short_tol_probe --action-id A-20260915T101559-5bba5bc1 --device cuda --tol 1e-5 --target-steps 64 --continue-to-128-if-pass64
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/short_tol_probe/source/src/pidon/pidon_solve.py` | 70 KB | `5d6eb695526117ef` |
| `evidence/server_resource_v1/short_tol_probe/source/scripts/experiments/phase1_full_run.py` | 29 KB | `e54a1c1576df5af8` |
| `evidence/server_resource_v1/short_tol_probe/source/scripts/experiments/server_local_review.py` | 15 KB | `dcc697b8182b01a1` |
| `evidence/server_resource_v1/short_tol_probe/source/src/pidon/pidon_recording.py` | 14 KB | `6a22cf4e2dcafba7` |
| `evidence/server_resource_v1/short_tol_probe/source/scripts/experiments/server_short_tol_probe.py` | 13 KB | `5ffa09aeb51d9339` |
| `evidence/server_resource_v1/short_tol_probe/source/src/pidon/dco.py` | 13 KB | `1bc6c9de416064e3` |
| `evidence/server_resource_v1/short_tol_probe/source/src/pidon/pidon_contract.py` | 11 KB | `fbf93008fd698a03` |
| `evidence/server_resource_v1/short_tol_probe/source/scripts/experiments/server_phase1_compare.py` | 10 KB | `450ea1101425e4c4` |
| `evidence/server_resource_v1/short_tol_probe/source/scripts/experiments/server_compute_probe.py` | 8 KB | `a553515c185a9b79` |
| `evidence/server_resource_v1/short_tol_probe/source/tools/server_batch2_queue.py` | 6 KB | `404b5d4722054aab` |
| `evidence/server_resource_v1/short_tol_probe/source/tools/server_resource_queue.py` | 4 KB | `232f6811c89d7942` |
| `evidence/server_resource_v1/short_tol_probe/source/src/pidon/paper_protocol.py` | 4 KB | `baf9a989a414a752` |
| … 另有 2 个 | | |
...
```
Traceback (most recent call last):
  File "H:\PI-DON\run.py", line 95, in <module>
    main()
  File "H:\PI-DON\run.py", line 91, in main
    runpy.run_path(str(matches[0]), run_name='__main__')
  File "<frozen runpy>", line 291, in run_path
  File "<frozen runpy>", line 98, in _run_module_code
  File "<frozen runpy>", line 88, in _run_code
  File "H:\PI-DON\scripts\experiments\server_short_tol_probe.py", line 336, in <module>
    run(parser.parse_args())
  File "H:\PI-DON\scripts\experiments\server_short_tol_probe.py", line 208, in run
    recorder = RunRecorder(out, metadata, mode="existing")
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "H:\PI-DON\src\pidon\pidon_recording.py", line 108, in __init__
    raise ValueError(f"unknown recorder mode {mode!r}")
ValueError: unknown recorder mode 'existing'
```

</details>

## #299　2026-09-15T18:25:46　FAILED (exit 1)

**SR-SHORT TOL1E5-P bounded 64-step field probe**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T102540-2d7d00e8 server_short_tol_probe --action-id A-20260915T102540-2d7d00e8 --device cuda --tol 1e-5 --target-steps 64 --output-name short_tol_probe_r1 --continue-to-128-if-pass64
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/short_tol_probe_r1/source/src/pidon/pidon_solve.py` | 70 KB | `5d6eb695526117ef` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/scripts/experiments/phase1_full_run.py` | 29 KB | `e54a1c1576df5af8` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/scripts/experiments/server_local_review.py` | 15 KB | `dcc697b8182b01a1` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/src/pidon/pidon_recording.py` | 14 KB | `6a22cf4e2dcafba7` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/scripts/experiments/server_short_tol_probe.py` | 13 KB | `16f6368fb75f81f7` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/src/pidon/dco.py` | 13 KB | `1bc6c9de416064e3` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/src/pidon/pidon_contract.py` | 11 KB | `fbf93008fd698a03` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/scripts/experiments/server_phase1_compare.py` | 10 KB | `450ea1101425e4c4` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/tools/server_batch2_queue.py` | 8 KB | `88fd3cdef20caa90` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/scripts/experiments/server_compute_probe.py` | 8 KB | `a553515c185a9b79` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/tools/server_resource_queue.py` | 4 KB | `232f6811c89d7942` |
| `evidence/server_resource_v1/short_tol_probe_r1/source/src/pidon/paper_protocol.py` | 4 KB | `baf9a989a414a752` |
| … 另有 2 个 | | |
...
Traceback (most recent call last):
  ...
  File "<frozen runpy>", line 98, in _run_module_code
  File "<frozen runpy>", line 88, in _run_code
  File "H:\PI-DON\scripts\experiments\server_short_tol_probe.py", line 337, in <module>
    run(parser.parse_args())
  File "H:\PI-DON\scripts\experiments\server_short_tol_probe.py", line 208, in run
    recorder = RunRecorder(out, metadata, mode="new")
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "H:\PI-DON\src\pidon\pidon_recording.py", line 128, in __init__
    raise ValueError("new run directory is non-empty; refusing to mix evidence")
ValueError: new run directory is non-empty; refusing to mix evidence
```

</details>

## #300　2026-09-15T18:50:29　OK

**SR-SHORT TOL1E5-P bounded 64-step field probe**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T102902-9b618d25 server_short_tol_probe --action-id A-20260915T102902-9b618d25 --device cuda --tol 1e-5 --target-steps 64 --output-name short_tol_probe_r2 --continue-to-128-if-pass64
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/short_tol_probe_r2/checkpoint_A.pt` | 147,130 KB | `75771b679acd9c2c` |
| `evidence/server_resource_v1/short_tol_probe_r2/failure_raw_000001_attempt_1.pt` | 147,130 KB | `f0932e71859a634d` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/src/pidon/pidon_solve.py` | 70 KB | `5d6eb695526117ef` |
| `evidence/server_resource_v1/short_tol_probe_r2/summary.json` | 33 KB | `0cfe1eb251d4fb48` |
| `evidence/server_resource_v1/short_tol_probe_r2/steps.jsonl` | 16 KB | `f49b11d7de6e4e37` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/scripts/experiments/server_local_review.py` | 15 KB | `dcc697b8182b01a1` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/scripts/experiments/server_short_tol_probe.py` | 14 KB | `6be3e41dd1662a62` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/src/pidon/pidon_recording.py` | 14 KB | `6a22cf4e2dcafba7` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/src/pidon/dco.py` | 13 KB | `1bc6c9de416064e3` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/src/pidon/fdtd.py` | 11 KB | `622a8a7747245d35` |
| `evidence/server_resource_v1/short_tol_probe_r2/source/tools/server_batch2_queue.py` | 8 KB | `e33dc2ecea922759` |
| `evidence/server_resource_v1/short_tol_probe_r2/manifest.json` | 4 KB | `f783bffd97432946` |
| … 另有 6 个 | | |

<details><summary>输出末尾</summary>

```
{"status": "FAIL", "scientific_result": "FAIL", "accepted_steps": 0, "updates": 3000, "output": "H:\\PI-DON\\evidence\\server_resource_v1\\short_tol_probe_r2"}
```

</details>

## #301　2026-09-15T22:45:11　OK

**SR-E1-BUDGET first E fixed-state budget probe**

```
C:\Users\ZZY\.conda\envs\pidon311\python.exe run.py --action A-20260915T144224-63c5e568 server_first_e_budget_probe --action-id A-20260915T144224-63c5e568 --device cuda --max-inner 9000
```
...
| 产生/修改的文件 | 大小 | sha256 (前 16 位) |
|---|---|---|
| `evidence/server_resource_v1/first_e_budget_probe/checkpoint_A.pt` | 146,802 KB | `26e13747e1bb3b5d` |
| `evidence/server_resource_v1/first_e_budget_probe/snapshot_step_0001.pt` | 146,802 KB | `9eca8bb9b9af0a5f` |
| `evidence/server_resource_v1/first_e_budget_probe/source/src/pidon/pidon_solve.py` | 70 KB | `5d6eb695526117ef` |
| `evidence/server_resource_v1/first_e_budget_probe/summary.json` | 49 KB | `9c84285f22fed835` |
| `evidence/server_resource_v1/first_e_budget_probe/steps.jsonl` | 29 KB | `c6c3ab830ca3dea7` |
| `evidence/server_resource_v1/first_e_budget_probe/source/scripts/experiments/server_failure_mechanism_audit.py` | 17 KB | `a2411a18ebc1d51a` |
| `evidence/server_resource_v1/first_e_budget_probe/source/scripts/experiments/server_short_tol_probe.py` | 14 KB | `6be3e41dd1662a62` |
| `evidence/server_resource_v1/first_e_budget_probe/source/src/pidon/pidon_recording.py` | 14 KB | `6a22cf4e2dcafba7` |
| `evidence/server_resource_v1/first_e_budget_probe/source/src/pidon/dco.py` | 13 KB | `1bc6c9de416064e3` |
| `evidence/server_resource_v1/first_e_budget_probe/source/src/pidon/fdtd.py` | 11 KB | `622a8a7747245d35` |
| `evidence/server_resource_v1/first_e_budget_probe/source/scripts/experiments/server_first_e_budget_probe.py` | 9 KB | `916a5b6a58236261` |
| `evidence/server_resource_v1/first_e_budget_probe/source/tools/server_first_e_queue.py` | 5 KB | `51f0271e361cb33e` |
| … 另有 6 个 | | |

<details><summary>输出末尾</summary>

```
{"status": "PASS", "scientific_result": "DIAGNOSTIC_PASS", "accepted_steps": 1, "updates": 3769, "residual_ratio": 9.972317421921325e-06, "output": "H:\\PI-DON\\evidence\\server_resource_v1\\first_e_budget_probe"}
```
