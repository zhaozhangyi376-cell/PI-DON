...
| ID | 状态 | 观测 |
|---|---|---|
| C01 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C02 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C03 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C04 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C05 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C06 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C07 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C08 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C09 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C10 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C11 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C12 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C13 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C14 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
| C15 | PASS | `{"present": true, "lab_run": 202, "contract_status": "PASS"}` |
...
| M01 | PASS | `{"lab_run": 202, "valid_lab_record": true}` |
| M02 | PASS | `{"lab_run": 202, "valid_lab_record": true}` |
| M03 | PASS | `{"lab_run": 202, "valid_lab_record": true}` |
| M04 | PASS | `{"lab_run": 202, "valid_lab_record": true}` |
| M05 | PASS | `{"lab_run": 202, "valid_lab_record": true}` |
| M11 | PASS | `{"restored": true, "rolling_pointer": true}` |
| M12 | PASS | `{"snapshot": "C:\\PI-DON\\evidence\\gpt6_plan_v4_night\\g0_after_head_integration\\reference_cache_snapshots.npz", "hash_match": true, "steps": 8192}` |
